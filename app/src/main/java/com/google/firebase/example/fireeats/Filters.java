...
public class Filters {
    ...
    public static Filters getDefault() {
        ...
        filters.setSortBy(Restaurant.FIELD_NUM_RATINGS);
    ...
    public boolean hasNumRatings() { return (numRatings > 0);}
    ...
    public String getOrderDescription(Context context) {
        if (Restaurant.FIELD_POPULARITY.equals(sortBy)) {

...
public class FilterDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private Query.Direction getSortDirection() {
        String selected = (String) mSortSpinner.getSelectedItem();
        if (getString(R.string.sort_by_rating).equals(selected)) { //Sort By Week
            return Query.Direction.DESCENDING;
        } if (getString(R.string.sort_by_price).equals(selected)) { //Sort By Month
            return Query.Direction.DESCENDING;
        } if (getString(R.string.sort_by_popularity).equals(selected)) { //Sort By Due Date
            return Query.Direction.DESCENDING;
        }
